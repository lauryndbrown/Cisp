      ...
      *     PERFORM DEBUG-LISP.
      ...
      D         DISPLAY "After POP-CALL-STACK:" WS-RECURSION-OBJECT
               MOVE WS-COMMAND-NAME TO WS-CURR-COMMAND
                PERFORM EVALUATE-CURRENT-COMMAND
      D         DISPLAY "AFTER EVALUATE-CURRENT-COMMAND:"
      D         WS-RECURSION-OBJECT " " WS-CURRENT-VALUE
           END-IF.
      D     display " ".
       PRINT-CALL-STACK.
      ...
      ************ Evalute values
      ...
      D     DISPLAY "APPLY-VALUE-TO-EXPRESSION".
       ...
       LISP-ADD-PROCEDURE.
           ...
           END-IF.
      D     DISPLAY "ADD-- WS-CURRENT-VALUE-NUMERIC:"
      D     WS-CURRENT-VALUE-NUMERIC " WS-COMMAND-RESULT-NUMERIC:"
      D     WS-COMMAND-RESULT-NUMERIC
      D     " WS-CURRENT-VALUE: " WS-CURRENT-VALUE.
