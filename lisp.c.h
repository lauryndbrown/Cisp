...
static const cob_field c_15	= {7, (cob_u8_ptr)"NUMERIC", &a_1};
static const cob_field c_16	= {5, (cob_u8_ptr)"OTHER", &a_1};
static const cob_field c_17	= {24, (cob_u8_ptr)"EVALUATE-CURRENT-COMMAND", &a_1};
