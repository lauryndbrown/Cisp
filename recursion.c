...
#define  COB_MODULE_FORMATTED_DATE	"Apr 22 2017 22:43:19"
#define  COB_MODULE_DATE		20170422
#define  COB_MODULE_TIME		224319
...
RECURSION_ (const int entry, cob_u8_t *b_40, cob_u8_t *b_41)
{
  ...
  l_2:;
  cob_trace_section (st_2, st_1, 68);
  cob_trace_section (st_3, st_1, 68);

  /* Line: 68        : Paragraph MAIN-PROCEDURE          : recursion.cbl */
  cob_trace_section (st_4, st_1, 68);

  /* Line: 69        : EVALUATE           : recursion.cbl */
  cob_set_location (st_1, 69, NULL, st_5, st_6);
  ...
  if (((int)cob_cmp (COB_SET_DATA (f_40, b_40), (cob_field *)&c_2) == 0))
  {
    ...
    cob_set_location (st_1, 75, NULL, st_5, st_7);
  ...
  if (((int)cob_cmp (COB_SET_DATA (f_40, b_40), (cob_field *)&c_3) == 0))
  {
    ...
    cob_set_location (st_1, 78, NULL, st_5, st_7);
  ...
  if (((int)cob_cmp (COB_SET_DATA (f_40, b_40), (cob_field *)&c_5) == 0))
  {
    ...
    cob_set_location (st_1, 84, NULL, st_5, st_7);
  ...
  if (((int)cob_cmp (COB_SET_DATA (f_40, b_40), (cob_field *)&c_6) == 0))
  {
    ...
    cob_set_location (st_1, 86, NULL, st_5, st_7);
  ...
  if (((int)cob_cmp (COB_SET_DATA (f_40, b_40), (cob_field *)&c_7) == 0))
  {
    ...
    cob_set_location (st_1, 89, NULL, st_5, st_7);
  ...
  cob_set_location (st_1, 90, NULL, st_5, st_8);
  goto exit_program;

  /* Line: 91        : Paragraph LOG-INIT-CALL-STACK     : recursion.cbl */
  l_6:;
  cob_trace_section (st_9, st_1, 91);
  ...
  cob_set_location (st_1, 94, NULL, st_10, st_11);
  cob_move ((cob_field *)&c_9, &f_39);

  /* Line: 95        : CALL               : recursion.cbl */
  cob_set_location (st_1, 95, NULL, st_10, st_12);
  ...
  l_7:;
  cob_trace_section (st_13, st_1, 96);

  /* Line: 98        : MOVE               : recursion.cbl */
  cob_set_location (st_1, 98, NULL, st_14, st_11);
  memcpy (b_37, "RECURSION:ADD-TO-CALL-STACK             ", 40);

  /* Line: 100       : STRING             : recursion.cbl */
  cob_set_location (st_1, 100, NULL, st_14, st_15);
  ...
  cob_set_location (st_1, 104, NULL, st_14, st_11);
  memcpy (b_36, "ADD  ", 5);

  /* Line: 105       : CALL               : recursion.cbl */
  cob_set_location (st_1, 105, NULL, st_14, st_12);
  cob_procedure_params[0] = &f_36;
  cob_procedure_params[1] = &f_37;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_LOGGER.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
  ...
  l_8:;
  cob_trace_section (st_16, st_1, 106);

  /* Line: 108       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 108, NULL, st_17, st_11);
  memcpy (b_37, "RECURSION:GET-TOP-CALL-STACK            ", 40);

  /* Line: 110       : STRING             : recursion.cbl */
  cob_set_location (st_1, 110, NULL, st_17, st_15);
  cob_string_init (&f_39, NULL);
  cob_string_delimited (NULL);
  cob_string_append (&f_7);
  cob_string_delimited (NULL);
  ...
  cob_set_location (st_1, 114, NULL, st_17, st_11);
  memcpy (b_36, "ADD  ", 5);

  /* Line: 115       : CALL               : recursion.cbl */
  cob_set_location (st_1, 115, NULL, st_17, st_12);
  cob_procedure_params[0] = &f_36;
  cob_procedure_params[1] = &f_37;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_LOGGER.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
  ...
  l_9:;
  cob_trace_section (st_18, st_1, 116);

  /* Line: 117       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 117, NULL, st_19, st_11);
  cob_move ((cob_field *)&c_10, &f_38);

  /* Line: 119       : STRING             : recursion.cbl */
  cob_set_location (st_1, 119, NULL, st_19, st_15);
  cob_string_init (&f_39, NULL);
  cob_string_delimited (NULL);
  cob_string_append (&f_7);
  cob_string_delimited (NULL);
  ...
  cob_set_location (st_1, 123, NULL, st_19, st_11);
  memcpy (b_36, "ADD  ", 5);

  /* Line: 124       : CALL               : recursion.cbl */
  cob_set_location (st_1, 124, NULL, st_19, st_12);
  cob_procedure_params[0] = &f_36;
  cob_procedure_params[1] = &f_37;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_LOGGER.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
  ...
  l_10:;
  cob_trace_section (st_20, st_1, 125);

  /* Line: 126       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 126, NULL, st_21, st_11);
  memcpy (b_37, "RECURSION:IS-EMPTY-CALL-STACK           ", 40);

  /* Line: 128       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 128, NULL, st_21, st_11);
  cob_move (&f_34, &f_39);

  /* Line: 129       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 129, NULL, st_21, st_11);
  memcpy (b_36, "ADD  ", 5);

  /* Line: 130       : CALL               : recursion.cbl */
  cob_set_location (st_1, 130, NULL, st_21, st_12);
  cob_procedure_params[0] = &f_36;
  cob_procedure_params[1] = &f_37;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_LOGGER.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
  ...
  l_11:;
  cob_trace_section (st_22, st_1, 131);

  /* Line: 133       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 133, NULL, st_23, st_11);
  memcpy (b_37, "RECURSION:CLOSE-CALL-STACK              ", 40);

  /* Line: 135       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 135, NULL, st_23, st_11);
  cob_move ((cob_field *)&c_11, &f_39);

  /* Line: 136       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 136, NULL, st_23, st_11);
  memcpy (b_36, "ADD  ", 5);

  /* Line: 137       : CALL               : recursion.cbl */
  cob_set_location (st_1, 137, NULL, st_23, st_12);
  cob_procedure_params[0] = &f_36;
  cob_procedure_params[1] = &f_37;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_LOGGER.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
  ...
  cob_trace_section (st_24, st_1, 138);

  /* Line: 140       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 140, NULL, st_25, st_11);
  memcpy (b_37, "RECURSION:DELETE-FROM-CALL-STACK        ", 40);

  /* Line: 142       : STRING             : recursion.cbl */
  cob_set_location (st_1, 142, NULL, st_25, st_15);
  cob_string_init (&f_39, NULL);
  cob_string_delimited (NULL);
  cob_string_append (&f_7);
  cob_string_delimited (NULL);
  ...
  cob_set_location (st_1, 146, NULL, st_25, st_11);
  memcpy (b_36, "ADD  ", 5);

  /* Line: 147       : CALL               : recursion.cbl */
  cob_set_location (st_1, 147, NULL, st_25, st_12);
  cob_procedure_params[0] = &f_36;
  cob_procedure_params[1] = &f_37;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_LOGGER.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
  ...
  l_13:;
  cob_trace_section (st_26, st_1, 148);

  /* Line: 151       : OPEN               : recursion.cbl */
  cob_set_location (st_1, 151, NULL, st_27, st_28);
  ...
  cob_set_location (st_1, 152, NULL, st_27, st_29);
  ...
  cob_set_location (st_1, 154, NULL, st_27, st_28);
  ...
  cob_set_location (st_1, 155, NULL, st_27, st_11);
  memcpy (b_25, "00001", 5);

  /* Line: 156       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 156, NULL, st_27, st_11);
  memcpy (b_31 + 5, "00001", 5);

  /* Line: 157       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 157, NULL, st_27, st_11);
  memcpy (b_31, "00001", 5);

  /* Line: 158       : SET                : recursion.cbl */
  cob_set_location (st_1, 158, NULL, st_27, st_30);
  *(b_31 + 10) = 78;
  ...
  l_14:;
  cob_trace_section (st_31, st_1, 159);

  /* Line: 160       : CLOSE              : recursion.cbl */
  cob_set_location (st_1, 160, NULL, st_32, st_29);
  cob_close (h_CALL_STACK, NULL, 0, 0);
  if (unlikely(cob_glob_ptr->cob_exception_code != 0))
  {
    /* PERFORM Default Error Handler */
  ...
  cob_set_location (st_1, 161, NULL, st_32, st_33);
  ...
  l_15:;
  cob_trace_section (st_34, st_1, 162);

  /* Line: 163       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 163, NULL, st_35, st_11);
  cob_check_numeric (&f_25, "WS-CALL-STACK-NEXT-ID");
  memcpy (b_14, b_25, 5);

  /* Line: 164       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 164, NULL, st_35, st_11);
  ...
  cob_set_location (st_1, 166, NULL, st_35, st_11);
  *(b_14 + 50) = *(b_41 + 40);

  /* Line: 167       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 167, NULL, st_35, st_11);
  cob_check_numeric (&f_32, "WS-LAST-ID");
  memcpy (b_14 + 45, b_31, 5);

  /* Line: 168       : WRITE              : recursion.cbl */
  cob_set_location (st_1, 168, NULL, st_35, st_36);
  ...
  cob_set_location (st_1, 169, NULL, st_35, st_37);
  if (((int)(int)(*(b_31 + 10) - 89) == 0))
  {

    /* Line: 170       : MOVE               : recursion.cbl */
    cob_set_location (st_1, 170, NULL, st_35, st_11);
    cob_check_numeric (&f_25, "WS-CALL-STACK-NEXT-ID");
    memcpy (b_31 + 5, b_25, 5);
  }

  /* Line: 172       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 172, NULL, st_35, st_11);
  cob_check_numeric (&f_25, "WS-CALL-STACK-NEXT-ID");
  memcpy (b_31, b_25, 5);

  /* Line: 173       : ADD                : recursion.cbl */
  cob_set_location (st_1, 173, NULL, st_35, st_38);
  cob_check_numeric (&f_25, "WS-CALL-STACK-NEXT-ID");
  ...
  /* Line: 174       : Paragraph PRINT-CALL-STACK-PROCEDURE: recursion.cbl */
  l_16:;
  cob_trace_section (st_39, st_1, 174);

  /* Line: 175       : DISPLAY            : recursion.cbl */
  cob_set_location (st_1, 175, NULL, st_40, st_41);
  cob_display (0, 1, 1, &c_12);

  /* Line: 176       : DISPLAY            : recursion.cbl */
  cob_set_location (st_1, 176, NULL, st_40, st_41);
  cob_display (0, 1, 5, &c_13, &c_14, &c_15, &c_16, &c_17);

  /* Line: 180       : PERFORM            : recursion.cbl */
  cob_set_location (st_1, 180, NULL, st_40, st_7);
  memcpy (b_14, "00001", 5);
  for (;;)
  {
    ...
    /* Line: 182       : READ               : recursion.cbl */
    cob_set_location (st_1, 182, NULL, st_40, st_42);
    ...
    if (unlikely(cob_glob_ptr->cob_exception_code != 0))
    {
      if (cob_glob_ptr->cob_exception_code == 0x0506)
      {
        ...
        cob_set_location (st_1, 184, NULL, st_40, st_41);
    ...
    /* Line: 186       : DISPLAY            : recursion.cbl */
    cob_set_location (st_1, 186, NULL, st_40, st_41);
  ...
  /* Line: 191       : Paragraph CALL-STACK-GET-TOP-PROCEDURE: recursion.cbl */
  l_17:;
  cob_trace_section (st_43, st_1, 191);

  /* Line: 192       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 192, NULL, st_44, st_11);
  cob_check_numeric (&f_32, "WS-LAST-ID");
  memcpy (b_14, b_31, 5);

  /* Line: 193       : READ               : recursion.cbl */
  cob_set_location (st_1, 193, NULL, st_44, st_42);
  cob_read (h_CALL_STACK, &f_7, NULL, 0);
  if (unlikely(cob_glob_ptr->cob_exception_code != 0))
  {
    /* PERFORM Default Error Handler */
  ...
  /* Line: 196       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 196, NULL, st_44, st_11);
  memmove (b_41, b_14 + 5, 20);

  /* Line: 197       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 197, NULL, st_44, st_11);
  ...
  /* Line: 198       : Paragraph POP-CALL-STACK-PROCEDURE: recursion.cbl */
  l_18:;
  cob_trace_section (st_45, st_1, 198);

  /* Line: 199       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 199, NULL, st_46, st_11);
  cob_check_numeric (&f_32, "WS-LAST-ID");
  memcpy (b_14, b_31, 5);

  /* Line: 202       : READ               : recursion.cbl */
  cob_set_location (st_1, 202, NULL, st_46, st_42);
  cob_read (h_CALL_STACK, &f_7, NULL, 0);
  if (unlikely(cob_glob_ptr->cob_exception_code != 0))
  {
    /* PERFORM Default Error Handler */
  ...
  /* Line: 203       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 203, NULL, st_46, st_11);
  memmove (b_41, b_14 + 5, 20);

  /* Line: 204       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 204, NULL, st_46, st_11);
  memmove (b_41 + 20, b_14 + 25, 20);

  /* Line: 205       : MOVE               : recursion.cbl */
  cob_set_location (st_1, 205, NULL, st_46, st_11);
  cob_check_numeric (&f_11, "COMMAND-RETURN-ID");
  memcpy (b_31, b_14 + 45, 5);

  /* Line: 206       : DELETE             : recursion.cbl */
  cob_set_location (st_1, 206, NULL, st_46, st_33);
  ...
  /* Line: 207       : IF                 : recursion.cbl */
  cob_set_location (st_1, 207, NULL, st_46, st_37);
  if (((int)memcmp (b_14, b_31 + 5, 5) == 0))
  {

    /* Line: 208       : SET                : recursion.cbl */
    cob_set_location (st_1, 208, NULL, st_46, st_30);
    *(b_31 + 10) = 89;
  }

  /* Line: 211       : DISPLAY            : recursion.cbl */
  cob_set_location (st_1, 211, NULL, st_46, st_41);
  ...
  /* Line: 212       : Paragraph IS-STACK-EMPTY-PROCEDURE: recursion.cbl */
  l_19:;
  cob_trace_section (st_47, st_1, 212);

  /* Line: 213       : IF                 : recursion.cbl */
  cob_set_location (st_1, 213, NULL, st_48, st_37);
  if (((int)(int)(*(b_31 + 10) - 89) == 0))
  {

    /* Line: 214       : MOVE               : recursion.cbl */
    cob_set_location (st_1, 214, NULL, st_48, st_11);
  ...
  else
  {
    ...
    /* Line: 216       : MOVE               : recursion.cbl */
    cob_set_location (st_1, 216, NULL, st_48, st_11);
  ...
  /* Trace program exit */
  cob_trace_section (st_49, NULL, 0);
