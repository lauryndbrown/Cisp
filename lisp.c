...
/* Generated at           Apr 24 2017 14:52:13 */
...
#define  COB_MODULE_FORMATTED_DATE	"Apr 24 2017 14:52:13"
#define  COB_MODULE_DATE		20170424
#define  COB_MODULE_TIME		145213
...
LISP_ (const int entry, cob_u8_t *b_23)
{
  ...
  *(b_10) = 78;
  ...
  /* Line: 154       : Paragraph APPLY-VALUE-TO-EXPRESSION: LISP.cbl */
  l_16:;

  /* Line: 155       : MOVE               : LISP.cbl */
  cob_set_location (st_1, 155, NULL, st_21, st_6);
  memcpy (b_7, b_17, 20);

  /* Line: 156       : PERFORM            : LISP.cbl */
  cob_set_location (st_1, 156, NULL, st_21, st_3);
  /* PERFORM EVALUATE-CURRENT-COMMAND */
  frame_ptr++;
  if (unlikely(frame_ptr == frame_overflow))
      cob_fatal_error (COB_FERROR_STACK);
  ...
  /* Line: 158       : Paragraph LISP-WRITE-PROCEDURE    : LISP.cbl */
  l_17:;

  /* Line: 159       : MOVE               : LISP.cbl */
  cob_set_location (st_1, 159, NULL, st_22, st_6);
  memcpy (b_17 + 20, b_8, 20);

  /* Line: 160       : DISPLAY            : LISP.cbl */
  cob_set_location (st_1, 160, NULL, st_22, st_15);
  ...
  /* Line: 161       : Paragraph LISP-ADD-PROCEDURE      : LISP.cbl */
  l_18:;

  /* Line: 162       : IF                 : LISP.cbl */
  cob_set_location (st_1, 162, NULL, st_23, st_7);
  if (((int)cob_cmp (&f_20, &cob_all_space) == 0))
  {

    /* Line: 163       : MOVE               : LISP.cbl */
    cob_set_location (st_1, 163, NULL, st_23, st_6);
    memset (b_17 + 20, 48, 20);
  }

  /* Line: 169       : ADD                : LISP.cbl */
  cob_set_location (st_1, 169, NULL, st_23, st_24);
  cob_add (&f_20, &f_9, 0);
  ...
  /* Line: 170       : Paragraph LOG-COMMAND-EVALUTATION : LISP.cbl */
  l_19:;

  /* Line: 171       : MOVE               : LISP.cbl */
  cob_set_location (st_1, 171, NULL, st_25, st_6);
  memcpy (b_12, "ADD  ", 5);
  ...
  /* Line: 175       : STRING             : LISP.cbl */
  cob_set_location (st_1, 175, NULL, st_25, st_19);
  cob_string_init (&f_15, NULL);
  cob_string_delimited (NULL);
  ...
  /* Line: 178       : CALL               : LISP.cbl */
  cob_set_location (st_1, 178, NULL, st_25, st_10);
  cob_procedure_params[0] = &f_12;
  cob_procedure_params[1] = &f_13;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_LOGGER.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
