...
/* Generated at           Apr 24 2017 17:58:13 */
...
#define  COB_MODULE_FORMATTED_DATE	"Apr 24 2017 17:58:13"
#define  COB_MODULE_DATE		20170424
#define  COB_MODULE_TIME		175813
...
LISP_ (const int entry, cob_u8_t *b_23)
{
  ...
  /* Line: 75        : IF                 : lisp.cbl */
  cob_set_location (st_1, 75, NULL, st_11, st_7);
  if (((int)cob_cmp (&f_18, &cob_all_space) == 0))
  {

    /* Line: 76        : MOVE               : lisp.cbl */
    cob_set_location (st_1, 76, NULL, st_11, st_6);
    memcpy (b_17, b_7, 20);
  }
  else
  {
    ...
    cob_set_location (st_1, 79, NULL, st_11, st_6);
    memcpy (b_16, "ADD-TO-CALL-STACK             ", 30);

    /* Line: 80        : CALL               : lisp.cbl */
    cob_set_location (st_1, 80, NULL, st_11, st_10);
    cob_procedure_params[0] = &f_16;
  ...
  /* Line: 89        : SET                : lisp.cbl */
  cob_set_location (st_1, 89, NULL, st_11, st_5);
  *(b_10) = 78;
  ...
  /* Line: 90        : Paragraph RETURN-PROCEDURE        : lisp.cbl */
  l_8:;

  /* Line: 92        : MOVE               : lisp.cbl */
  cob_set_location (st_1, 92, NULL, st_12, st_6);
  cob_move ((cob_field *)&c_4, &f_16);

  /* Line: 93        : CALL               : lisp.cbl */
  cob_set_location (st_1, 93, NULL, st_12, st_10);
  cob_procedure_params[0] = &f_16;
  cob_glob_ptr->cob_call_params = 1;
  if (unlikely(call_RECURSION.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
    call_RECURSION.funcvoid = cob_resolve_cobol ("RECURSION", 0, 1);
  ...
  /* Line: 95        : IF                 : lisp.cbl */
  cob_set_location (st_1, 95, NULL, st_12, st_7);
  if (!((int)cob_cmp (&f_16, (cob_field *)&c_5) == 0))
  {

    /* Line: 96        : MOVE               : lisp.cbl */
    cob_set_location (st_1, 96, NULL, st_12, st_6);
    memcpy (b_8, b_17 + 20, 20);

    /* Line: 98        : PERFORM            : lisp.cbl */
    cob_set_location (st_1, 98, NULL, st_12, st_3);
    ...
    /* Line: 100       : MOVE               : lisp.cbl */
    cob_set_location (st_1, 100, NULL, st_12, st_6);
    memcpy (b_7, b_17, 20);

    /* Line: 101       : PERFORM            : lisp.cbl */
    cob_set_location (st_1, 101, NULL, st_12, st_3);
    /* PERFORM EVALUATE-CURRENT-COMMAND */
    frame_ptr++;
    if (unlikely(frame_ptr == frame_overflow))
        cob_fatal_error (COB_FERROR_STACK);
  ...
  /* Line: 108       : Paragraph PRINT-CALL-STACK        : lisp.cbl */

  /* Line: 109       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 109, NULL, st_13, st_6);
  memcpy (b_16, "PRINT-CALL-STACK              ", 30);

  /* Line: 110       : CALL               : lisp.cbl */
  cob_set_location (st_1, 110, NULL, st_13, st_10);
  cob_procedure_params[0] = &f_16;
  cob_glob_ptr->cob_call_params = 1;
  if (unlikely(call_RECURSION.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
    call_RECURSION.funcvoid = cob_resolve_cobol ("RECURSION", 0, 1);
  ...
  /* Line: 111       : Paragraph DEBUG-LISP              : lisp.cbl */
  ...
  /* Line: 114       : DISPLAY            : lisp.cbl */
  cob_set_location (st_1, 114, NULL, st_14, st_15);
  cob_display (0, 1, 2, &c_8, &f_18);

  /* Line: 115       : DISPLAY            : lisp.cbl */
  cob_set_location (st_1, 115, NULL, st_14, st_15);
  cob_display (0, 1, 2, &c_9, &f_19);

  /* Line: 116       : DISPLAY            : lisp.cbl */
  cob_set_location (st_1, 116, NULL, st_14, st_15);
  cob_display (0, 1, 1, &c_10);

  /* Line: 117       : Paragraph POP-CALL-STACK          : lisp.cbl */
  l_11:;

  /* Line: 119       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 119, NULL, st_16, st_6);
  cob_move ((cob_field *)&c_11, &f_16);

  /* Line: 120       : CALL               : lisp.cbl */
  cob_set_location (st_1, 120, NULL, st_16, st_10);
  cob_procedure_params[0] = &f_16;
  cob_procedure_params[1] = &f_17;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_RECURSION.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
  ...
  /* Line: 122       : Paragraph CLOSE-CALL-STACK-PROCEDURE: lisp.cbl */
  l_12:;

  /* Line: 123       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 123, NULL, st_17, st_6);
  cob_move ((cob_field *)&c_12, &f_16);

  /* Line: 124       : CALL               : lisp.cbl */
  cob_set_location (st_1, 124, NULL, st_17, st_10);
  cob_procedure_params[0] = &f_16;
  cob_glob_ptr->cob_call_params = 1;
  if (unlikely(call_RECURSION.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
    call_RECURSION.funcvoid = cob_resolve_cobol ("RECURSION", 0, 1);
  ...
  /* Line: 125       : Paragraph LOG-CURRENT-COMMAND-PROCEDURE: lisp.cbl */
  l_13:;

  /* Line: 127       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 127, NULL, st_18, st_6);
  memcpy (b_12, "ADD  ", 5);

  /* Line: 128       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 128, NULL, st_18, st_6);
  cob_move ((cob_field *)&c_13, &f_14);

  /* Line: 130       : STRING             : lisp.cbl */
  cob_set_location (st_1, 130, NULL, st_18, st_19);
  ...
  cob_set_location (st_1, 133, NULL, st_18, st_10);
  ...
  /* Line: 134       : Paragraph EVALUATE-CURRENT-COMMAND: lisp.cbl */
  l_14:;

  /* Line: 135       : EVALUATE           : lisp.cbl */
  cob_set_location (st_1, 135, NULL, st_20, st_4);
  ...
  if (((int)cob_cmp (&f_7, (cob_field *)&c_16) == 0))
  {
    ...
    /* Line: 141       : PERFORM            : lisp.cbl */
    cob_set_location (st_1, 141, NULL, st_20, st_3);
  ...
  else
  {
    ...
    /* Line: 148       : IF                 : lisp.cbl */
    cob_set_location (st_1, 148, NULL, st_20, st_7);
    if ((((int)(int)(*(b_7 + 0) - 34) == 0) && 
        ((int)(int)(*(b_7 + (cob_get_numdisp (b_23 + 5004 + 2 * (cob_get_numdisp (b_6, 4) - 1), 2) - 1)) - 34) == 0)))
    {

      /* Line: 151       : MOVE               : lisp.cbl */
      cob_set_location (st_1, 151, NULL, st_20, st_6);
      memcpy (b_8, b_7, 20);
    }
    else
    {
      ...
      /* Line: 153       : DISPLAY            : lisp.cbl */
      cob_set_location (st_1, 153, NULL, st_20, st_15);
      cob_display (0, 1, 3, &c_17, &f_7, &c_18);

      /* Line: 155       : STOP RUN           : lisp.cbl */
      cob_set_location (st_1, 155, NULL, st_20, st_21);
      cob_stop_run (b_1);
    }

    /* Line: 158       : PERFORM            : lisp.cbl */
    cob_set_location (st_1, 158, NULL, st_20, st_3);
  ...
  /* Line: 160       : Paragraph APPLY-VALUE-TO-EXPRESSION: lisp.cbl */
  l_16:;

  /* Line: 161       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 161, NULL, st_22, st_6);
  memcpy (b_7, b_17, 20);

  /* Line: 162       : PERFORM            : lisp.cbl */
  cob_set_location (st_1, 162, NULL, st_22, st_3);
  /* PERFORM EVALUATE-CURRENT-COMMAND */
  frame_ptr++;
  if (unlikely(frame_ptr == frame_overflow))
      cob_fatal_error (COB_FERROR_STACK);
  ...
  /* Line: 164       : Paragraph LISP-PRINT-PROCEDURE    : lisp.cbl */
  l_17:;

  /* Line: 165       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 165, NULL, st_23, st_6);
  memcpy (b_17 + 20, b_8, 20);

  /* Line: 166       : DISPLAY            : lisp.cbl */
  cob_set_location (st_1, 166, NULL, st_23, st_15);
  ...
  /* Line: 167       : Paragraph LISP-ADD-PROCEDURE      : lisp.cbl */
  l_18:;

  /* Line: 168       : IF                 : lisp.cbl */
  cob_set_location (st_1, 168, NULL, st_24, st_7);
  if (((int)cob_cmp (&f_20, &cob_all_space) == 0))
  {

    /* Line: 169       : MOVE               : lisp.cbl */
    cob_set_location (st_1, 169, NULL, st_24, st_6);
    memset (b_17 + 20, 48, 20);
  }

  /* Line: 175       : ADD                : lisp.cbl */
  cob_set_location (st_1, 175, NULL, st_24, st_25);
  cob_add (&f_20, &f_9, 0);
  ...
  /* Line: 176       : Paragraph LOG-COMMAND-EVALUTATION : lisp.cbl */
  l_19:;

  /* Line: 177       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 177, NULL, st_26, st_6);
  memcpy (b_12, "ADD  ", 5);

  /* Line: 178       : STRING             : lisp.cbl */
  cob_set_location (st_1, 178, NULL, st_26, st_19);
  ...
  /* Line: 181       : STRING             : lisp.cbl */
  cob_set_location (st_1, 181, NULL, st_26, st_19);
  cob_string_init (&f_15, NULL);
  cob_string_delimited (NULL);
  ...
  /* Line: 184       : CALL               : lisp.cbl */
  cob_set_location (st_1, 184, NULL, st_26, st_10);
  cob_procedure_params[0] = &f_12;
  cob_procedure_params[1] = &f_13;
  cob_glob_ptr->cob_call_params = 2;
  if (unlikely(call_LOGGER.funcvoid == NULL || cob_glob_ptr->cob_physical_cancel)) {
