...
#define  COB_MODULE_FORMATTED_DATE	"Apr 22 2017 20:43:01"
#define  COB_MODULE_DATE		20170422
#define  COB_MODULE_TIME		204301
...
LISP_ (const int entry, cob_u8_t *b_23)
{
  ...
  *(b_10) = 78;
  ...
  /* Line: 144       : Paragraph OTHER-PROCEDURES        : lisp.cbl */
  cob_trace_section (st_38, st_1, 144);

  /* Line: 171       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 171, NULL, st_39, st_9);
  cob_move ((cob_field *)&c_14, &f_14);
