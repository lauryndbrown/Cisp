...
/* Generated at           Apr 22 2017 17:44:04 */
...
#define  COB_MODULE_FORMATTED_DATE	"Apr 22 2017 17:44:04"
#define  COB_MODULE_DATE		20170422
#define  COB_MODULE_TIME		174404
...
LISP_ (const int entry, cob_u8_t *b_19)
{
  ...
  for (;;)
  {
    ...
    /* Line: 44        : EVALUATE           : lisp.cbl */
    cob_set_location (st_1, 44, NULL, st_5, st_8);
    ...
    COB_SET_FLD(f0, 50, b_19 + 1 + 50 * (cob_get_numdisp (b_6, 4) - 1), &a_1) ), (cob_field *)&c_4) == 0))
    {
      ...
      /* Line: 48        : DISPLAY            : lisp.cbl */
      cob_set_location (st_1, 48, NULL, st_5, st_6);
      cob_display (0, 1, 1, &c_5);

      /* Line: 49        : MOVE               : lisp.cbl */
      cob_set_location (st_1, 49, NULL, st_5, st_9);
  ...
  /* Line: 105       : DISPLAY            : lisp.cbl */
  cob_set_location (st_1, 105, NULL, st_23, st_6);
  cob_display (0, 1, 1, &c_14);

  /* Line: 108       : IF                 : lisp.cbl */
  cob_set_location (st_1, 108, NULL, st_23, st_16);
  if (cob_is_numeric (
  (cob_check_ref_mod (1, cob_get_numdisp (b_19 + 2001 + 2 * (cob_get_numdisp (b_6, 4) - 1), 2), 100, "WS-CURR-COMMAND"),
  COB_SET_FLD(f0, cob_get_numdisp (b_19 + 2001 + 2 * (cob_get_numdisp (b_6, 4) - 1), 2), b_7 + 0, &a_1) )))
  {

    /* Line: 111       : MOVE               : lisp.cbl */
    cob_set_location (st_1, 111, NULL, st_23, st_9);
    cob_move (&f_7, &f_16);

    /* Line: 112       : DISPLAY            : lisp.cbl */
    cob_set_location (st_1, 112, NULL, st_23, st_6);
    cob_display (0, 1, 1, &c_15);

    /* Line: 113       : DISPLAY            : lisp.cbl */
    cob_set_location (st_1, 113, NULL, st_23, st_6);
  ...
  else
  {
    ...
    cob_set_location (st_1, 116, NULL, st_23, st_6);
  ...
  /* Line: 121       : Paragraph OTHER-PROCEDURES        : lisp.cbl */
  cob_trace_section (st_24, st_1, 121);

  /* Line: 154       : MOVE               : lisp.cbl */
  cob_set_location (st_1, 154, NULL, st_25, st_9);
  cob_move ((cob_field *)&c_17, &f_10);
