...
static cob_u8_t	b_31[5] __attribute__((aligned));	/* WS-LOG-OPERATION-FLAG */
static cob_u8_t	b_32[140] __attribute__((aligned));	/* WS-LOG-RECORD */
...
static cob_field f_31	= {5, b_31, &a_1};	/* WS-LOG-OPERATION-FLAG */
static cob_field f_32	= {140, b_32, &a_2};	/* WS-LOG-RECORD */
static cob_field f_33	= {40, b_32, &a_1};	/* WS-LOG-RECORD-FUNCTION-NAME */
static cob_field f_34	= {100, b_32 + 40, &a_1};	/* WS-LOG-RECORD-MESSAGE */
static cob_field f_35	= {30, NULL, &a_1};	/* LS-RECURSION-FLAG */
